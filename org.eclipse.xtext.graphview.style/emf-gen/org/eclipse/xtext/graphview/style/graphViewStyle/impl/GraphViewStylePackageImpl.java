...
public class GraphViewStylePackageImpl extends EPackageImpl implements GraphViewStylePackage
{
	 ...
	 * @generated
	 */
	public EReference getStyleSheet_ImportSection()
	{
	...
	public void createPackageContents()
	{
		...
		createEReference(styleSheetEClass, STYLE_SHEET__IMPORT_SECTION);
	...
	public void initializePackageContents()
	{
		...
		styleEClass.getESuperTypes().add(theTypesPackage.getJvmIdentifiableElement());
		...
		initEReference(getStyleSheet_ImportSection(), theXtypePackage.getXImportSection(), null, "importSection", null, 0, 1, StyleSheet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
