 ...
 * @generated
 */
public class GraphViewStyleSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case GraphViewStylePackage.STYLE:
			{
				...
				if (result == null) result = caseJvmIdentifiableElement(style);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
