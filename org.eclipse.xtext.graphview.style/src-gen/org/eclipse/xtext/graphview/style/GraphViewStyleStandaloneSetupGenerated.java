...
public class GraphViewStyleStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new GraphViewStyleRuntimeModule());
	}
	...
	public void register(Injector injector) {
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("gvstyle", serviceProvider);
	}
}
