...
public abstract class AbstractGraphViewStyleSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == GraphViewStylePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case GraphViewStylePackage.STYLE_SHEET:
			...
			case GraphViewStylePackage.XCOLOR_LITERAL:
				if(context == grammarAccess.getXAdditiveExpressionRule() ||
				   ...
				   context == grammarAccess.getXColorLiteralRule() ||
				   ...
				   context == grammarAccess.getXUnaryOperationRule()) {
					sequence_XColorLiteral(context, (XColorLiteral) semanticObject); 
					return; 
				}
				else break;
			}
	...
	protected void sequence_XColorLiteral(EObject context, XColorLiteral semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, GraphViewStylePackage.Literals.XCOLOR_LITERAL__COLOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GraphViewStylePackage.Literals.XCOLOR_LITERAL__COLOR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
