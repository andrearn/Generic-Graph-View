...
entryRuleDiagramMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDiagramMappingRule()); }
	iv_ruleDiagramMapping=ruleDiagramMapping
	{ $current=$iv_ruleDiagramMapping.current; }
	EOF;

// Rule DiagramMapping
ruleDiagramMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAbstractExpressionMapping returns [EObject current=null]:
	...
	{ $current=$iv_ruleAbstractExpressionMapping.current; }
	EOF;

// Rule AbstractExpressionMapping
ruleAbstractExpressionMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_NodeMapping_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_MappingCall_3.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleLabelMapping returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getLabelMappingRule()); }
	iv_ruleLabelMapping=ruleLabelMapping
	{ $current=$iv_ruleLabelMapping.current; }
	EOF;

// Rule LabelMapping
ruleLabelMapping returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleMappingCall returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getMappingCallRule()); }
	iv_ruleMappingCall=ruleMappingCall
	{ $current=$iv_ruleMappingCall.current; }
	EOF;

// Rule MappingCall
ruleMappingCall returns [EObject current=null]
@init {
	enterRule();
}
@after {
