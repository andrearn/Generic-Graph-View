...
public abstract class AbstractGraphViewMappingSemanticSequencer extends XbaseSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == GraphViewMappingPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case GraphViewMappingPackage.DIAGRAM_MAPPING:
				if(context == grammarAccess.getDiagramMappingRule()) {
					sequence_DiagramMapping(context, (DiagramMapping) semanticObject); 
					return; 
				}
				else break;
			case GraphViewMappingPackage.EDGE_END_MAPPING:
				if(context == grammarAccess.getEdgeEndMappingRule()) {
					sequence_EdgeEndMapping(context, (EdgeEndMapping) semanticObject); 
					return; 
				}
				else break;
			...
			case GraphViewMappingPackage.LABEL_MAPPING:
				if(context == grammarAccess.getAbstractExpressionMappingRule() ||
				   context == grammarAccess.getLabelMappingRule()) {
					sequence_LabelMapping(context, (LabelMapping) semanticObject); 
					return; 
				}
				else break;
			case GraphViewMappingPackage.MAPPING_CALL:
				if(context == grammarAccess.getAbstractExpressionMappingRule() ||
				   context == grammarAccess.getMappingCallRule()) {
					sequence_MappingCall(context, (MappingCall) semanticObject); 
					return; 
				}
				else break;
	 ...
	 */
	protected void sequence_DiagramMapping(EObject context, DiagramMapping semanticObject) {
	 ...
	 */
	protected void sequence_EdgeEndMapping(EObject context, EdgeEndMapping semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, GraphViewMappingPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GraphViewMappingPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
