...
import org.eclipse.xtext.graphview.map.ide.contentassist.antlr.GraphViewMappingParser;
import org.eclipse.xtext.graphview.map.ide.contentassist.antlr.PartialGraphViewMappingContentAssistParser;
import org.eclipse.xtext.graphview.map.ide.contentassist.antlr.internal.InternalGraphViewMappingLexer;
import org.eclipse.xtext.graphview.map.ui.contentassist.GraphViewMappingProposalProvider;
import org.eclipse.xtext.graphview.map.ui.editor.GraphViewMappingEditor;
import org.eclipse.xtext.graphview.map.ui.labeling.GraphViewMappingDescriptionLabelProvider;
import org.eclipse.xtext.graphview.map.ui.labeling.GraphViewMappingLabelProvider;
import org.eclipse.xtext.graphview.map.ui.outline.GraphViewMappingOutlineTreeProvider;
import org.eclipse.xtext.graphview.map.ui.quickfix.GraphViewMappingQuickfixProvider;
...
/**
 * Manual modifications go to {@link GraphViewMappingUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractGraphViewMappingUiModule extends DefaultXbaseUiModule {
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalGraphViewMappingLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.xtext.graphview.map.parser.antlr.internal.InternalGraphViewMappingLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return GraphViewMappingParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalGraphViewMappingLexer.class).toProvider(LexerProvider.create(InternalGraphViewMappingLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return GraphViewMappingLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(GraphViewMappingDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return GraphViewMappingOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return GraphViewMappingQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return GraphViewMappingProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return GraphViewMappingEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialGraphViewMappingContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("GraphViewMapping Compare");
	}
