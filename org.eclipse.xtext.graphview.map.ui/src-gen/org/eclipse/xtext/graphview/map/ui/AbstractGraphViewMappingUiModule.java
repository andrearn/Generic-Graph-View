...
public abstract class AbstractGraphViewMappingUiModule extends org.eclipse.xtext.xbase.ui.DefaultXbaseUiModule {
	...
	public void configureCompareViewerTitle(com.google.inject.Binder binder) {
		binder.bind(String.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.UIBindings.COMPARE_VIEWER_TITLE)).toInstance("GraphViewMapping Compare");
	}
