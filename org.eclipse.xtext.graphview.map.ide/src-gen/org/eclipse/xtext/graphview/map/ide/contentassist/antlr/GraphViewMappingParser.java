 ...
 */
package org.eclipse.xtext.graphview.map.ide.contentassist.antlr;
...
import org.eclipse.xtext.graphview.map.ide.contentassist.antlr.internal.InternalGraphViewMappingParser;
import org.eclipse.xtext.graphview.map.services.GraphViewMappingGrammarAccess;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class GraphViewMappingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(GraphViewMappingGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GraphViewMappingGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getAbstractExpressionMappingAccess().getAlternatives(), "rule__AbstractExpressionMapping__Alternatives");
			builder.put(grammarAccess.getEdgeEndMappingAccess().getAlternatives_0(), "rule__EdgeEndMapping__Alternatives_0");
			builder.put(grammarAccess.getMappingCallAccess().getAlternatives_0(), "rule__MappingCall__Alternatives_0");
			...
			builder.put(grammarAccess.getDiagramMappingAccess().getGroup(), "rule__DiagramMapping__Group__0");
			builder.put(grammarAccess.getDiagramMappingAccess().getGroup_8(), "rule__DiagramMapping__Group_8__0");
			builder.put(grammarAccess.getNodeMappingAccess().getGroup(), "rule__NodeMapping__Group__0");
			builder.put(grammarAccess.getNodeMappingAccess().getGroup_9(), "rule__NodeMapping__Group_9__0");
			builder.put(grammarAccess.getLabelMappingAccess().getGroup(), "rule__LabelMapping__Group__0");
			builder.put(grammarAccess.getLabelMappingAccess().getGroup_6(), "rule__LabelMapping__Group_6__0");
			builder.put(grammarAccess.getEdgeMappingAccess().getGroup(), "rule__EdgeMapping__Group__0");
			builder.put(grammarAccess.getEdgeMappingAccess().getGroup_12(), "rule__EdgeMapping__Group_12__0");
			builder.put(grammarAccess.getEdgeEndMappingAccess().getGroup(), "rule__EdgeEndMapping__Group__0");
			builder.put(grammarAccess.getMappingCallAccess().getGroup(), "rule__MappingCall__Group__0");
			builder.put(grammarAccess.getMappingCallAccess().getGroup_0_0(), "rule__MappingCall__Group_0_0__0");
			builder.put(grammarAccess.getMappingCallAccess().getGroup_5(), "rule__MappingCall__Group_5__0");
			...
			builder.put(grammarAccess.getDiagramMappingAccess().getImportSectionAssignment_0(), "rule__DiagramMapping__ImportSectionAssignment_0");
			builder.put(grammarAccess.getDiagramMappingAccess().getNameAssignment_2(), "rule__DiagramMapping__NameAssignment_2");
			builder.put(grammarAccess.getDiagramMappingAccess().getTypeGuardAssignment_4(), "rule__DiagramMapping__TypeGuardAssignment_4");
			builder.put(grammarAccess.getDiagramMappingAccess().getMappingsAssignment_6(), "rule__DiagramMapping__MappingsAssignment_6");
			builder.put(grammarAccess.getDiagramMappingAccess().getUnlessConditionAssignment_8_1(), "rule__DiagramMapping__UnlessConditionAssignment_8_1");
			builder.put(grammarAccess.getNodeMappingAccess().getHiddenAssignment_0(), "rule__NodeMapping__HiddenAssignment_0");
			builder.put(grammarAccess.getNodeMappingAccess().getNameAssignment_2(), "rule__NodeMapping__NameAssignment_2");
			builder.put(grammarAccess.getNodeMappingAccess().getMultiAssignment_4(), "rule__NodeMapping__MultiAssignment_4");
			builder.put(grammarAccess.getNodeMappingAccess().getExpressionAssignment_5(), "rule__NodeMapping__ExpressionAssignment_5");
			builder.put(grammarAccess.getNodeMappingAccess().getMappingsAssignment_7(), "rule__NodeMapping__MappingsAssignment_7");
			builder.put(grammarAccess.getNodeMappingAccess().getUnlessConditionAssignment_9_1(), "rule__NodeMapping__UnlessConditionAssignment_9_1");
			builder.put(grammarAccess.getLabelMappingAccess().getHiddenAssignment_0(), "rule__LabelMapping__HiddenAssignment_0");
			builder.put(grammarAccess.getLabelMappingAccess().getNameAssignment_2(), "rule__LabelMapping__NameAssignment_2");
			builder.put(grammarAccess.getLabelMappingAccess().getMultiAssignment_4(), "rule__LabelMapping__MultiAssignment_4");
			builder.put(grammarAccess.getLabelMappingAccess().getExpressionAssignment_5(), "rule__LabelMapping__ExpressionAssignment_5");
			builder.put(grammarAccess.getLabelMappingAccess().getUnlessConditionAssignment_6_1(), "rule__LabelMapping__UnlessConditionAssignment_6_1");
			builder.put(grammarAccess.getEdgeMappingAccess().getHiddenAssignment_0(), "rule__EdgeMapping__HiddenAssignment_0");
			builder.put(grammarAccess.getEdgeMappingAccess().getNameAssignment_2(), "rule__EdgeMapping__NameAssignment_2");
			builder.put(grammarAccess.getEdgeMappingAccess().getMultiAssignment_4(), "rule__EdgeMapping__MultiAssignment_4");
			builder.put(grammarAccess.getEdgeMappingAccess().getExpressionAssignment_5(), "rule__EdgeMapping__ExpressionAssignment_5");
			builder.put(grammarAccess.getEdgeMappingAccess().getSourceMappingAssignment_7(), "rule__EdgeMapping__SourceMappingAssignment_7");
			builder.put(grammarAccess.getEdgeMappingAccess().getTargetMappingAssignment_9(), "rule__EdgeMapping__TargetMappingAssignment_9");
			builder.put(grammarAccess.getEdgeMappingAccess().getMappingsAssignment_10(), "rule__EdgeMapping__MappingsAssignment_10");
			builder.put(grammarAccess.getEdgeMappingAccess().getUnlessConditionAssignment_12_1(), "rule__EdgeMapping__UnlessConditionAssignment_12_1");
			builder.put(grammarAccess.getEdgeEndMappingAccess().getCallAssignment_0_1(), "rule__EdgeEndMapping__CallAssignment_0_1");
			builder.put(grammarAccess.getEdgeEndMappingAccess().getReferencedMappingAssignment_1(), "rule__EdgeEndMapping__ReferencedMappingAssignment_1");
			builder.put(grammarAccess.getEdgeEndMappingAccess().getExpressionAssignment_3(), "rule__EdgeEndMapping__ExpressionAssignment_3");
			builder.put(grammarAccess.getMappingCallAccess().getHiddenAssignment_0_0_0(), "rule__MappingCall__HiddenAssignment_0_0_0");
			builder.put(grammarAccess.getMappingCallAccess().getCallAssignment_0_0_1(), "rule__MappingCall__CallAssignment_0_0_1");
			builder.put(grammarAccess.getMappingCallAccess().getReferencedMappingAssignment_1(), "rule__MappingCall__ReferencedMappingAssignment_1");
			builder.put(grammarAccess.getMappingCallAccess().getMultiAssignment_3(), "rule__MappingCall__MultiAssignment_3");
			builder.put(grammarAccess.getMappingCallAccess().getExpressionAssignment_4(), "rule__MappingCall__ExpressionAssignment_4");
			builder.put(grammarAccess.getMappingCallAccess().getUnlessConditionAssignment_5_1(), "rule__MappingCall__UnlessConditionAssignment_5_1");
	...
	@Override
	protected InternalGraphViewMappingParser createParser() {
		InternalGraphViewMappingParser result = new InternalGraphViewMappingParser(null);
