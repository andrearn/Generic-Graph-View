 ...
 */
package org.eclipse.xtext.graphview.style.ide.contentassist.antlr;
...
import org.eclipse.xtext.graphview.style.ide.contentassist.antlr.internal.InternalGraphViewStyleParser;
import org.eclipse.xtext.graphview.style.services.GraphViewStyleGrammarAccess;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class GraphViewStyleParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(GraphViewStyleGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GraphViewStyleGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getStyleAccess().getGroup_2(), "rule__Style__Group_2__0");
			builder.put(grammarAccess.getStyleAccess().getGroup_3(), "rule__Style__Group_3__0");
			...
			builder.put(grammarAccess.getStyleSheetAccess().getImportSectionAssignment_0(), "rule__StyleSheet__ImportSectionAssignment_0");
			builder.put(grammarAccess.getStyleSheetAccess().getNameAssignment_2(), "rule__StyleSheet__NameAssignment_2");
			builder.put(grammarAccess.getStyleSheetAccess().getDiagramMappingAssignment_4(), "rule__StyleSheet__DiagramMappingAssignment_4");
			builder.put(grammarAccess.getStyleSheetAccess().getStylesAssignment_5(), "rule__StyleSheet__StylesAssignment_5");
			builder.put(grammarAccess.getStyleAccess().getMappingsAssignment_1(), "rule__Style__MappingsAssignment_1");
			builder.put(grammarAccess.getStyleAccess().getMappingsAssignment_2_1(), "rule__Style__MappingsAssignment_2_1");
			builder.put(grammarAccess.getStyleAccess().getJavaClassAssignment_3_1(), "rule__Style__JavaClassAssignment_3_1");
			builder.put(grammarAccess.getStyleAccess().getExpressionAssignment_4(), "rule__Style__ExpressionAssignment_4");
			builder.put(grammarAccess.getXColorLiteralAccess().getColorAssignment(), "rule__XColorLiteral__ColorAssignment");
	...
	@Override
	protected InternalGraphViewStyleParser createParser() {
		InternalGraphViewStyleParser result = new InternalGraphViewStyleParser(null);
